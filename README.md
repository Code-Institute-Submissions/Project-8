...
* Modern typographies chosen and a friendly background image used to attract users, and to make them stay to explore further.
* A button placed to link to Resume page directly, for those users who would like to go straight to the point.
#### 'Aabout Me' page
* Playing with words by using different colors and typographies to give an emphasis on the keywords. It enables the users to read the keywords at a glance.
* Image chosen based on which I can express and convey my vision message to the users.
...
* Image, typography, icons and colors used to give colorful design effects, and also to give consistency in design from the previous page.
#### 'Contact' page
...
* Placeholders shown for the required information in the contact form.  It is to guide users what to fill in the contact form and it enables easier user experiences.
* More ways to contact are available in the footer. Icons, once clicked, will redirect the users to my Github page, Linkedin, Instagram, or trigger a call or an email.
* A image, typography, icons, and colors were used to give friendly feelings and consistency in terms of design aspects throughout the website.
...
* CSS3 - used to give design effects and style to the website. Also, media query used for responsive design.
...
* [Font Awesome](https://fontawesome.com) - used for the social media icons and an email icon placed in the footer.
* [Flaticon](https://www.flaticon.com) -  used for the rest of colorful icons in the portfolio websites.
# Testing
#### Links & Buttons
The main purpose of the test on links and buttons is to ensure that there are no bronken links upon clicking.
* Navbar - clicked on the navbar menus to test if the links can bring users to the clicked pages.
* Buttons - the 'View Resume'button on the landing page was tested if it is able to bring users to the Resume page (For other buttons, I did not assign any links)
* Icons & Phone Number in the footer - :
   * Social Media Icons were tested whether it is able to redirect users to the respective pages.
...
* When it was tested in my sister's iPhone XR, the background image in the main landing page was not shown. (In other family members' and friends' phones and laptops, it was nicely presented.)  
...
* Tested on ['Am I Responsive'](http://ami.responsivedesign.is) to virtually test before sending out the deployed URL for further testing on friends' and family's laptop and phones.
* Sent the deployed URL to friends and family to test whether the website works responsively without broken images or links in different media sizes (Test was done on laptops, Galaxy S2, iPhone XR, Oppo R11, Galaxy Tab A, and etc).
...
## Deployment
Github pages was used to host my portfolio website. It was deployed directly from the master branch, and therefore any chages made on the website was promptly updated accordingly.  
...
## Credit
#### Images
* [Unsplash](https://unsplash.com) - for backgroundn image used in the landing page & the Lego block image used in the Resume page
